...
func (agent *RECAgent) String() string {
	return agent.Name()
}
...
func (agent *RECAgent) DeliverBundle(bundleDescriptor *store.BundleDescriptor) error {
	return agent.mailboxes.Deliver(bundleDescriptor)
}

// DeliverAdminRecord doesn't do anything for this agent
func (agent *RECAgent) DeliverAdminRecord(_ *bpv7.Bundle) bool {
	return true
}
